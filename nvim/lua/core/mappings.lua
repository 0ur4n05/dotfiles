...
-- 42nvimheader
maps.n["<M-h>"] = { "<cmd>Stdheader<cr>", desc = "Insert 42 header" }


-- Normal --
-- Standard Operations
maps.n["<M-w>"] = { "<cmd>w<cr>", desc = "Save" }
maps.n["<M-q>"] = { "<cmd>q<cr>", desc = "Quit" }
maps.n["<M-n>"] = { "<cmd>enew<cr>", desc = "New File" }
...
if is_available "bufdelete.nvim" then
  maps.n["<M-c>"] = { function() require("bufdelete").bufdelete(0, false) end, desc = "Close buffer" }
  maps.n["<M-C>"] = { function() require("bufdelete").bufdelete(0, true) end, desc = "Force close buffer" }
else
  maps.n["<M-c>"] = { "<cmd>bdelete<cr>", desc = "Close buffer" }
  maps.n["<M-C>"] = { "<cmd>bdelete!<cr>", desc = "Force close buffer" }
end
...
if is_available "bufferline.nvim" then
  ...
  maps.n["<leader>j"] = { "<cmd>bprevious<cr>", desc = "Previous buffer" }
end

-- Comment
if is_available "Comment.nvim" then
  maps.n["<M-/>"] = { function() require("Comment.api").toggle.linewise.current() end, desc = "Comment line" }
  maps.v["<M-/>"] = {
...
if is_available "neo-tree.nvim" then
  ...
  maps.n["<M-E>"] = { "<cmd>Neotree focus<cr>", desc = "Focus Explorer" }
end
--
--
-- -- Package Manager
...
if is_available "smart-splits.nvim" then
  ...
  maps.n["<M-j>"] = { function() require("smart-splits").move_cursor_left() end, desc = "Move to left split" }
  maps.n["<M-k>"] = { function() require("smart-splits").move_cursor_down() end, desc = "Move to below split" }
  maps.n["<M-l>"] = { function() require("smart-splits").move_cursor_up() end, desc = "Move to above split" }
  ...
  maps.n["<M-j>"] = { "<C-w>h", desc = "Move to left split" }
  maps.n["<M-l>"] = { "<C-w>j", desc = "Move to below split" }
  maps.n["<M-k>"] = { "<C-w>k", desc = "Move to above split" }
  maps.n["<M-;>"] = { "<C-w>l", desc = "Move to right split" }
...
if is_available "telescope.nvim" then
  maps.n["<M-f>"] = { function() require("telescope.builtin").live_grep() end, desc = "Search words" }
  maps.n["<leader>fW"] = {
    function()
...
if is_available "toggleterm.nvim" then
  ...
  maps.n["<M-t>"] = { "<cmd>ToggleTerm size=10 direction=horizontal<cr>", desc = "ToggleTerm horizontal split" }
...
maps.t["<M-r>"] = { "<c-\\><c-n><c-w>h", desc = "Terminal left window navigation" }
